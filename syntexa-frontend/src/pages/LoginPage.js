                ...
                <form onSubmit={handleLogin} className="space-y-4 sm:space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full p-3 text-white bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg border border-gray-700 focus:border-purple-400 focus:ring focus:ring-purple-400 focus:ring-opacity-50 transition shadow-inner text-sm sm:text-base"
                            required
                        />
                    </div>
                    <div>
                    ...
                    <button 
                        type="submit" 
                        className="w-full py-3 px-4 bg-gradient-to-r from-purple-700 via-gray-900 to-gray-800 hover:from-purple-800 hover:to-gray-900 rounded-xl text-white font-bold transition-all duration-300 shadow-lg border border-purple-700/40 disabled:opacity-50 text-sm sm:text-base"
                        disabled={loading}
                    >
